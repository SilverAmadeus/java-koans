...
public class AboutStrings {
    ...
    public void implicitStrings() {
        assertEquals("just a plain ole string".getClass(), "String");
    }
    ...
    public void stringTrim() {
        ...
        assertEquals(" one more time         ".trim(), "one more time");
        assertEquals(" and again\t".trim(), "one more time");
        assertEquals("\t\t\twhat about now?\t".trim(), "one more time");
    }
    ...
    public void stringCompareIgnoreCase() {
        ...
        assertEquals(str.compareToIgnoreCase("I am a number one!") == 0, false);
        assertEquals(str.compareToIgnoreCase("I AM A NUMBER ONE!") == 0, false);
    }
    ...
    public void stringSubstring() {
        ...
        assertEquals(str.substring(7, str.length()), "mber ONE!");
    }
    ...
    public void readableStringFormattingWithStringFormat() {
        assertEquals(String.format("%s %s %s", "a", "b", "a"), "a b c");
    }
    ...
    public void insufficientArgumentsToMessageFormatDoesNotReplaceTheToken() {
        assertEquals(MessageFormat.format("{0} {1} {0}", "a"), "a a a");
    }
}
